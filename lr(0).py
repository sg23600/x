...
gram = {}
nt = int(input("Enter the number of productions: "))
for i in range(nt):
    nt_var = input("Enter the non terminal: ")
    n = input("Enter the terminal/variables separated by space: ")
    list_n = n.split(' ')
    gram[nt_var] = list_n
...
# terms = ["a","d","$"]
terms = input('Enter the terms seperated by spaces: ')
terms = terms.split(' ')
